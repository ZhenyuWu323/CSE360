...
void loop()
{
    ...
    if (PDterms.zEn)
    {
        ...
        fz = (fz - altitude) * PDterms.kpz - (desired_vz - altitudeVelocity) * PDterms.kdz + z_integral;
    ...
    if (PDterms.yawEn)
    {
        ...
        if (tz != yaw)
        {
            ...
            angle_diff = atan(sin(tz - yaw) / cos(tz - yaw));
            // Integral in yas
            ...
            tz = angle_diff * PDterms.kpyaw - (desired_vyaw - yawrate) * PDterms.kdyaw + yaw_integral;
