...
if __name__ == "__main__":
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kppyaw", 0.04) #0.04
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdyaw", 0)#.1
    serial.send_preference(ROBOT_MAC, DataType_Float, "kddyaw", 0.07)#0.01
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kpz", 0.3) #0.83, 0.3
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdz", 0.6) #0.6
    serial.send_preference(ROBOT_MAC, DataType_Float, "kiz", 0.05) #0.05
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "z_int_low", 0.33)
    serial.send_preference(ROBOT_MAC, DataType_Float, "z_int_high", 0.43)
    serial.send_preference(ROBOT_MAC, DataType_Float, "yawRateIntRange", 0)

    # // radius of the blimp
    serial.send_preference(ROBOT_MAC, DataType_Float, "lx", 0.12)
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "botZlim", 0)
