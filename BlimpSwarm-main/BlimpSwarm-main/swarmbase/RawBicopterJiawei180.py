...
if __name__ == "__main__":
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kppyaw", 0) #2
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdyaw", .15)#.1
    serial.send_preference(ROBOT_MAC, DataType_Float, "kddyaw", 0)#.1
    serial.send_preference(ROBOT_MAC, DataType_Float, "kiyaw", 0)
    serial.send_preference(ROBOT_MAC, DataType_Float, "kiyawrate", 0)

    serial.send_preference(ROBOT_MAC, DataType_Float, "yawrate_gamma", 0.85)
    serial.send_preference(ROBOT_MAC, DataType_Float, "rollrate_gamma", 0.85)
    serial.send_preference(ROBOT_MAC, DataType_Float, "pitchrate_gamma", 0.8)
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdroll", 0.1)
    serial.send_preference(ROBOT_MAC, DataType_Float, "kppitch", 0)
    serial.send_preference(ROBOT_MAC, DataType_Float, "kdpitch", -.1)
    ...
    serial.send_preference(ROBOT_MAC, DataType_Float, "pitchInvert", .5) #degrees
